...
export const Card: React.FC<IProduct> = ({id,name,image,description,stock,price,categoryId}) => {
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row w-full p-3 mt-4">
                <div className="w-full md:w-3/4 flex justify-center p-3 md:p-0">
                    <div className="border-gray-200 rounded-md border-2 md:shadow-xl p-2 md:p-0">
                        <img src={image} alt="" className="w-auto" />
                    </div>
                </div>
                <div className="w-full md:w-1/4 h-[500px] flex flex-col justify-evenly items-start border-gray-200 md:border-2 md:rounded-md md:ml-4 md:shadow-xl p-2 ">
                    <h2 className="text-[50px] font-semibold text-left">{name}</h2>
                    ...
                    <p className="text-[70px] md:text-[100px] font-bold">${price}</p>
                    <div className="flex w-full items-start">
                        <h2 className="ml-2 mr-2 text-3xl">Stock:</h2>
                        <p className="text-3xl">{stock}</p>
                    </div>
                    <button 
