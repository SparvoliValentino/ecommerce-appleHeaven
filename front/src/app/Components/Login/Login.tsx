...
export const Login = () => {
    ...
    return (
        <form className="max-w-xl mx-auto h-auto md:shadow-xl p-3" onSubmit={handleSumbit} autoComplete="off">
            ...
            <div className="flex">
                <h2 className="md:my-5 italic text-base md:text-[30px]">Dont have an account yet?<a className="ml-2 md:my-5 font-semibold text-base md:text-[30px]" href="/register">Sign up</a></h2>
