...
export const FilterProductsForm = () => {
    ...
    const handleApplyFilter = ()=>{
        if(selectedCategory === 0 || selectedCategory === null){
            ...
            router.push(`/product/Categories/${selectedCategory}`)
        }
    }
            ...
            {isMobile ? (
                <div className="w-full flex justify-start px-4 mb-4 relative">
                    <button
                        ...
                        className="w-full max-w-[350px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="button"
                        // onClick={click}
                    >
