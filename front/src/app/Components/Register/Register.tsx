...
export const Register = () => {
    ...
    return (
        <form className="max-w-xl mx-auto h-auto md:shadow-xl p-3" onSubmit={handleSumbit} autoComplete="off">
            ...
            <div className="w-full flex justify-center items-center">
                <button
                    type="submit"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-m  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Submit
                    </button>
            </div>
            <div className="w-full mt-4 flex flex-col justify-center items-center">
                <h2 className="italic text-black">Do you have an account?</h2>
                <a href="/login" className="mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-m  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Sing up</a>
            </div>
        </form>
    )
}
